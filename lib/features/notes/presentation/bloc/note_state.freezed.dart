...
abstract class $NoteStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Note> note, bool isLoading, String? errorMessage});
}
...
class _$NoteStateImpl implements _NoteState {
  ...
  @override
  String toString() {
    return 'NoteState(note: $note, isLoading: $isLoading, errorMessage: $errorMessage)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_note), isLoading, errorMessage);
